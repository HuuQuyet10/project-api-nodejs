...
import { createNft, deleteNft, getListBuyNft, getNftByid, searchNameProductNft, updateNft } from "../controllers/list-buy-nft.js";
import { checkMiddleware } from "../middleware/auth.js";
const router = express.Router();

// GET ALL NFT
router.get('/', checkMiddleware , getListBuyNft);
